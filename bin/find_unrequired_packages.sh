...
# Enter groups and packages here which you know you wish to keep. They will not be included in the list of unrequired packages later.
...
# Check each remaining package. If package is not required by anything and is not on your ignore list, print the package name to the screen.
for line in $loop; do
